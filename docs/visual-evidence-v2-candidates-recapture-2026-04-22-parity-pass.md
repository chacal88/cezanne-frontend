...
Confirmed:
- The capture script completed successfully and wrote 22 screenshots plus `recapture-records.json`.
...
|---|---|
| V2-GAP-004 to V2-GAP-012 | Improved; still blocked after side-by-side review. V2-GAP-007 now has a current-app Add column recapture, but exact legacy option/checkbox parity is not closed. |
