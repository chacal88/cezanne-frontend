...
- Move, hire, unhire, and review-request detail-hub action lifecycle states are now runtime-hook reachable through `fixtureAction` and `fixtureActionState`; current screenshots exist for review-request blocked, move parent-refresh, hire success, and unhire terminal, while remaining lifecycle variants and legacy parity review remain pending.
...
| No-match/reset, non-ready/mobile, and safe action hooks | `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/07-database-search-no-match.png` through `new/23-detail-unavailable-state.png`, plus `new/40-mobile-database-ready.png` and `new/41-mobile-detail-ready.png` | **Fixed current-capture only; still blocked** | Database no-match/reset now has deterministic current-app capture. Database/detail denied, stale/stale-context, unavailable, and mobile-width ready frames are current-app captureable. Upload success, review-request blocked, move-job parent-refresh, hire success, and unhire terminal are safely captureable through visible V2 hooks. Legacy side-by-side parity, product-approved mobile scope, and broader provider-blocked/terminal coverage remain required. |
| Schedule launcher | `visual-evidence-assets/v2/legacy/legacy-v2-candidate-action-schedule-opened-seeded-1440x900.png` vs `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/30-action-schedule-modal-route.png` | **Improved; still blocked** | Greenfield no longer uses a standalone task page for this state; it now renders a route-owned modal wizard with Diego ApiSeed context, dark header, job details, interview fields, and radio groups. Exact wizard dimensions, stepper/header placement, copy, metadata, and footer behavior still differ. |
| Offer/reject launchers | `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/31-action-offer-modal-route.png`, `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/32-action-reject-modal-route.png` | **Improved; still blocked** | Offer/reject now use modal-like route-owned surfaces with Diego ApiSeed context. Reject now includes the two-step message/editor surface, but exact editor controls, chip layout, modal dimensions, and reject-with/without-message footer actions still differ; offer still lacks final authenticated legacy comparison. |
| Email/review/move/score modals | `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/12-detail-email-candidate-modal.png` through `new/15-detail-score-now-modal.png` | **Improved; still blocked** | Entry points now exist from candidate detail. Email now includes template/editor/attachment composition, but exact legacy context, toolbar details, footer actions, draft/send behavior, and review/move/score field/header/footer parity remain open. |
| Database selected bulk and Add column | `visual-evidence-assets/v2/recapture-2026-04-22-parity-pass/new/05-database-row-selected-bulk-enabled.png`, `new/06-database-add-column-menu-parity-pass.png` | **Improved; still blocked** | Current capture now opens the selected-bulk dropdown and uses checkbox-style Add column options. Exact legacy toolbar/dropdown geometry, option order, selected-column behavior, and same-run authenticated legacy comparison remain open. |
