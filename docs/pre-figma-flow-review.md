...
- `visual-evidence-v5-sysadmin-platform.md` captures 21 desktop current-app screenshots across SysAdmin platform dashboard, users, favorite-request queue, master data, company subscription administration, taxonomy, and non-SysAdmin platform fallback.
