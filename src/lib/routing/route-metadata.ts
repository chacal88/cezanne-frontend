...
export const routeMetadataRegistry = {
  ...
  '/register': { routeId: routeIds.registerIndex, routeClass: routeClasses.publicToken, domain: 'auth', module: 'registration', directEntry: 'full', requiredCapability: 'canUseAuthTokenFlow', implementationState: 'implemented' },
  ...
  '/auth/cezanne': { routeId: routeIds.authCezanneMissingTenant, routeClass: routeClasses.publicToken, domain: 'auth', module: 'cezanne', directEntry: 'full', requiredCapability: 'canCompleteSsoCallback', implementationState: 'implemented' },
